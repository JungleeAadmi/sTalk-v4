...
const ChatView = ({ activeUser, currentUser, socket, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      {/* HEADER */}
      <div className="flex-none h-24 bg-white dark:bg-gray-800 px-4 flex items-center gap-3 shadow-sm z-10 border-b dark:border-gray-700 transition-colors safe-area-top sticky top-0">
